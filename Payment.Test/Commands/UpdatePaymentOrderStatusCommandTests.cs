...
{
    public class UpdatePaymentOrderStatusCommandTests
    {
        private Fixture _fixture;
        public UpdatePaymentOrderStatusCommandTests()
        {
        ...
        public async Task Succcess_Case(CancellationToken cancellationToken)
        {
            ...
            var handler = mock.Create<UpdatePaymentOrderStatusCommandHandler>();
            var request = _fixture.Create<UpdatePaymentOrderStatusCommand>();
